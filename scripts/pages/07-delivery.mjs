...
const body = `
    ...
    <section class="section section-white" aria-label="How it arrives">
      <div class="wrap two-col">
        ...
        <div class="reveal reveal-d1">
          <span class="eyebrow">Road-legal by design</span>
          <h2>This is how it arrives</h2>
    ...
    <section class="section section-white" aria-labelledby="map-h">
      <div class="wrap two-col">
        <div class="reveal">
    ...
    <section class="section" aria-labelledby="dfaq-h">
      <div class="wrap-narrow">
