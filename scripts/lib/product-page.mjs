      ...
      <div class="wrap">
        ...
        <div class="product-hero-inner" style="padding-top:0">
          <div>
            ...
            <p style="color:#93A5BB;font-size:var(--fs-300);margin-top:-1rem;margin-bottom:2rem">Fixed delivered quote for your postcode — including transport, customs and installation — within one business day.</p>
